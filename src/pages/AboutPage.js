...
const AboutPage = (props) => {
    return(
        <div>
            ...
            <Content>
                <p>I am an experienced Product Owner who successfully managed the development of API connections and products at Hopper. After a covid-related layoff, I decided to go back to school for a computer science degree. After taking core classes such as Data Structures, Web Development, Databases, and Assembly,  I have become comfortable as a developer. I am currently learning full-stack professional development with React and MERN through https://fullstackopen.com/.</p>
                ...
                <p>Languages/Frameworks: Javascript, Python3, SQL, ReactJS, HTML+CSS</p>
                <p>Technologies: NodeJS, ExpressJS, MongoDB, Mongoose, Bootstrap, Heroku</p>
